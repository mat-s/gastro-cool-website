...
add_action('acf/init', function () {
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      [ 'key' => 'field_additional_image_links','label' => 'Additional Images','name' => 'additional_image_links','type' => 'gallery','return_format' => 'id','preview_size' => 'thumbnail','insert' => 'append','instructions' => 'Additional product images from feed.', 'wrapper' => ['width' => '100'] ],
