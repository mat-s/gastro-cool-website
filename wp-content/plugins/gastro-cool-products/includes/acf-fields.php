...
add_action('acf/init', function () {
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      [ 'key' => 'field_series','label' => 'Series','name' => 'series','type' => 'text','instructions' => 'Product series from feed (e.g., ECO STAR+).', 'wrapper' => ['width' => '50'] ],
      [ 'key' => 'field_featured_image_source_url','label' => 'Featured Image','name' => 'featured_image_source_url','type' => 'image','return_format' => 'id','preview_size' => 'thumbnail','instructions' => 'Featured product image (WP Media Library attachment).', 'wrapper' => ['width' => '100'] ],
      [ 'key' => 'field_additional_image_links','label' => 'Additional Images','name' => 'additional_image_links','type' => 'repeater','layout' => 'table','button_label' => 'Add Image','instructions' => 'Additional product images from feed.', 'sub_fields' => [ [ 'key' => 'field_additional_image_link_url','label' => 'Image','name' => 'image','type' => 'image','return_format' => 'id','preview_size' => 'thumbnail', 'instructions' => 'Product image (WP Media Library attachment).' ] ] ],
      ...
      [ 'key' => 'tab_content_lists', 'label' => 'Features & Benefits', 'type' => 'tab' ],
      [ 'key' => 'field_features','label' => 'Features','name' => 'features','type' => 'repeater','layout' => 'table','button_label' => 'Add Feature','instructions' => 'Product features from feed (<features>/<feature>).', 'sub_fields' => [ [ 'key' => 'field_feature_text','label' => 'Text','name' => 'text','type' => 'text' ] ] ],
      [ 'key' => 'field_benefits','label' => 'Benefits','name' => 'benefits','type' => 'repeater','layout' => 'table','button_label' => 'Add Benefit','instructions' => 'Product benefits from feed (<benefits>/<benefit>).', 'sub_fields' => [ [ 'key' => 'field_benefit_text','label' => 'Text','name' => 'text','type' => 'text' ] ] ],
